...
func (c *Client) ListUnspentMinMaxAddresses(minConf, maxConf int, addrs []ltcutil.Address) ([]sebtcjson.ListUnspentResult, error) {
...
// multisignature address and script needed to redeem it.
func (c *Client) CreateMultisig(requiredSigs int, addresses []ltcutil.Address) (*sebtcjson.CreateMultiSigResult, error) {

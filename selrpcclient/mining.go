...
func (c *Client) SubmitBlockAsync(block *ltcutil.Block, options *sebtcjson.SubmitBlockOptions) FutureSubmitBlockResult {
	blockHex := ""
	if block != nil {
...
func (c *Client) SubmitBlock(block *ltcutil.Block, options *sebtcjson.SubmitBlockOptions) error {

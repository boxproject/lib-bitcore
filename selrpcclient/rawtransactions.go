...
func (c *Client) GetRawTransactionAsync(txHash *chainhash.Hash) FutureGetRawTransactionResult {
	...
	cmd := sebtcjson.NewGetRawTransactionCmd(hash, sebtcjson.Int(0))
...
func (r FutureGetRawTransactionVerboseResult) Receive() (*sebtcjson.TxRawResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var rawTxResult sebtcjson.TxRawResult
...
func (c *Client) GetRawTransactionVerboseAsync(txHash *chainhash.Hash) FutureGetRawTransactionVerboseResult {
	...
	cmd := sebtcjson.NewGetRawTransactionCmd(hash, sebtcjson.Int(1))
	return c.sendCmd(cmd)
}
...
func (r FutureDecodeRawTransactionResult) Receive() (*sebtcjson.TxRawResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
...
func (c *Client) DecodeRawTransactionAsync(serializedTx []byte) FutureDecodeRawTransactionResult {
	...
	cmd := sebtcjson.NewDecodeRawTransactionCmd(txHex)
	return c.sendCmd(cmd)
}

// DecodeRawTransaction returns information about a transaction given its
// serialized bytes.
func (c *Client) DecodeRawTransaction(serializedTx []byte) (*sebtcjson.TxRawResult, error) {
...
func (c *Client) CreateRawTransactionAsync(inputs []sebtcjson.TransactionInput,
...
func (c *Client) CreateRawTransaction(inputs []sebtcjson.TransactionInput,
...
func (r FutureSignRawTransactionResult) Receive() (*wire.MsgTx, bool, error) {
	...
	var signRawTxResult sebtcjson.SignRawTransactionResult
...
func (c *Client) SignRawTransaction2Async(tx *wire.MsgTx, inputs []sebtcjson.RawTxInput) FutureSignRawTransactionResult {
	txHex := ""
	if tx != nil {
		// Serialize the transaction and convert to hex string.
		buf := bytes.NewBuffer(make([]byte, 0, tx.SerializeSize()))
...
// transactions.
func (c *Client) SignRawTransaction2(tx *wire.MsgTx, inputs []sebtcjson.RawTxInput) (*wire.MsgTx, bool, error) {
...
func (c *Client) SignRawTransaction4Async(tx *wire.MsgTx,
	inputs []sebtcjson.RawTxInput, privKeysWIF []string,
	...
	cmd := sebtcjson.NewSignRawTransactionCmd(txHex, &inputs, &privKeysWIF,
		sebtcjson.String(string(hashType)))
	return c.sendCmd(cmd)
}
...
func (c *Client) SearchRawTransactionsAsync(address ltcutil.Address, skip, count int, reverse bool, filterAddrs []string) FutureSearchRawTransactionsResult {
	...
	verbose := sebtcjson.Int(0)
	cmd := sebtcjson.NewSearchRawTransactionsCmd(addr, verbose, &skip, &count,
...
// Receive waits for the response promised by the future and returns the
// found raw transactions.
func (r FutureSearchRawTransactionsVerboseResult) Receive() ([]*sebtcjson.SearchRawTransactionsResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var result []*sebtcjson.SearchRawTransactionsResult
...
func (c *Client) SearchRawTransactionsVerboseAsync(address ltcutil.Address, skip,
	...
	addr := address.EncodeAddress()
	verbose := sebtcjson.Int(1)
	var prevOut *int
	if includePrevOut {
		prevOut = sebtcjson.Int(1)
	}
	cmd := sebtcjson.NewSearchRawTransactionsCmd(addr, verbose, &skip, &count,
...
func (c *Client) SearchRawTransactionsVerbose(address ltcutil.Address, skip,
	count int, includePrevOut, reverse bool, filterAddrs []string) ([]*sebtcjson.SearchRawTransactionsResult, error) {
...
func (r FutureDecodeScriptResult) Receive() (*sebtcjson.DecodeScriptResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var decodeScriptResult sebtcjson.DecodeScriptResult
...
func (c *Client) DecodeScriptAsync(serializedScript []byte) FutureDecodeScriptResult {
	...
	cmd := sebtcjson.NewDecodeScriptCmd(scriptHex)
	return c.sendCmd(cmd)
}

// DecodeScript returns information about a script given its serialized bytes.
func (c *Client) DecodeScript(serializedScript []byte) (*sebtcjson.DecodeScriptResult, error) {

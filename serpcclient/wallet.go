...
func (r FutureGetTransactionResult) Receive() (*sebtcjson.GetTransactionResult, error) {
...
func (r FutureListTransactionsResult) Receive() ([]sebtcjson.ListTransactionsResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
...
func (c *Client) ListTransactionsAsync(account string) FutureListTransactionsResult {
	cmd := sebtcjson.NewListTransactionsCmd(&account, nil, nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListTransactions(account string) ([]sebtcjson.ListTransactionsResult, error) {
...
func (c *Client) ListTransactionsCountAsync(account string, count int) FutureListTransactionsResult {
	cmd := sebtcjson.NewListTransactionsCmd(&account, &count, nil, nil)
	return c.sendCmd(cmd)
}
...
// different options.
func (c *Client) ListTransactionsCount(account string, count int) ([]sebtcjson.ListTransactionsResult, error) {
...
func (r FutureListUnspentResult) Receive() ([]sebtcjson.ListUnspentResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var unspent []sebtcjson.ListUnspentResult
...
func (c *Client) ListUnspentAsync() FutureListUnspentResult {
	cmd := sebtcjson.NewListUnspentCmd(nil, nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListUnspentMinAsync(minConf int) FutureListUnspentResult {
	cmd := sebtcjson.NewListUnspentCmd(&minConf, nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListUnspentMinMaxAsync(minConf, maxConf int) FutureListUnspentResult {
	cmd := sebtcjson.NewListUnspentCmd(&minConf, &maxConf, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListUnspentMinMaxAddressesAsync(minConf, maxConf int, addrs []btcutil.Address) FutureListUnspentResult {
	...
	cmd := sebtcjson.NewListUnspentCmd(&minConf, &maxConf, &addrStrs)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListUnspent() ([]sebtcjson.ListUnspentResult, error) {
...
func (c *Client) ListUnspentMin(minConf int) ([]sebtcjson.ListUnspentResult, error) {
...
// a filter.
func (c *Client) ListUnspentMinMax(minConf, maxConf int) ([]sebtcjson.ListUnspentResult, error) {
...
func (c *Client) ListUnspentMinMaxAddresses(minConf, maxConf int, addrs []btcutil.Address) ([]sebtcjson.ListUnspentResult, error) {
...
func (r FutureListSinceBlockResult) Receive() (*sebtcjson.ListSinceBlockResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
...
func (c *Client) ListSinceBlockAsync(blockHash *chainhash.Hash) FutureListSinceBlockResult {
	...
	cmd := sebtcjson.NewListSinceBlockCmd(hash, nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListSinceBlockMinConfAsync(blockHash *chainhash.Hash, minConfirms int) FutureListSinceBlockResult {
	...
	cmd := sebtcjson.NewListSinceBlockCmd(hash, &minConfirms, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListSinceBlockMinConf(blockHash *chainhash.Hash, minConfirms int) (*sebtcjson.ListSinceBlockResult, error) {
...
func (c *Client) LockUnspentAsync(unlock bool, ops []*wire.OutPoint) FutureLockUnspentResult {
	outputs := make([]sebtcjson.TransactionInput, len(ops))
	for i, op := range ops {
		outputs[i] = sebtcjson.TransactionInput{
			Txid: op.Hash.String(),
			Vout: op.Index,
		}
	}
	cmd := sebtcjson.NewLockUnspentCmd(unlock, outputs)
	return c.sendCmd(cmd)
}
...
func (r FutureListLockUnspentResult) Receive() ([]*wire.OutPoint, error) {
	...
	var inputs []sebtcjson.TransactionInput
...
func (c *Client) ListLockUnspentAsync() FutureListLockUnspentResult {
	cmd := sebtcjson.NewListLockUnspentCmd()
	return c.sendCmd(cmd)
}
...
func (c *Client) SetTxFeeAsync(fee btcutil.Amount) FutureSetTxFeeResult {
	cmd := sebtcjson.NewSetTxFeeCmd(fee.ToBTC())
	return c.sendCmd(cmd)
}
...
func (c *Client) SendFromAsync(fromAccount string, toAddress btcutil.Address, amount btcutil.Amount) FutureSendFromResult {
	...
	cmd := sebtcjson.NewSendFromCmd(fromAccount, addr, amount.ToBTC(), nil,
		nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) SendFromMinConfAsync(fromAccount string, toAddress btcutil.Address, amount btcutil.Amount, minConfirms int) FutureSendFromResult {
	addr := toAddress.EncodeAddress()
	cmd := sebtcjson.NewSendFromCmd(fromAccount, addr, amount.ToBTC(),
		&minConfirms, nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) SendManyAsync(fromAccount string, amounts map[btcutil.Address]btcutil.Amount) FutureSendManyResult {
	...
	cmd := sebtcjson.NewSendManyCmd(fromAccount, convertedAmounts, nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) SendManyMinConfAsync(fromAccount string,
	...
	cmd := sebtcjson.NewSendManyCmd(fromAccount, convertedAmounts,
		&minConfirms, nil)
	return c.sendCmd(cmd)
}
...
func (r FutureCreateMultisigResult) Receive() (*sebtcjson.CreateMultiSigResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var multisigRes sebtcjson.CreateMultiSigResult
...
func (c *Client) CreateMultisigAsync(requiredSigs int, addresses []btcutil.Address) FutureCreateMultisigResult {
	...
	cmd := sebtcjson.NewCreateMultisigCmd(requiredSigs, addrs)
	return c.sendCmd(cmd)
}
...
// multisignature address and script needed to redeem it.
func (c *Client) CreateMultisig(requiredSigs int, addresses []btcutil.Address) (*sebtcjson.CreateMultiSigResult, error) {
...
func (c *Client) CreateNewAccountAsync(account string) FutureCreateNewAccountResult {
	cmd := sebtcjson.NewCreateNewAccountCmd(account)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetAccountAsync(address btcutil.Address) FutureGetAccountResult {
	addr := address.EncodeAddress()
	cmd := sebtcjson.NewGetAccountCmd(addr)
	return c.sendCmd(cmd)
}
...
func (c *Client) SetAccountAsync(address btcutil.Address, account string) FutureSetAccountResult {
	addr := address.EncodeAddress()
	cmd := sebtcjson.NewSetAccountCmd(addr, account)
	return c.sendCmd(cmd)
}
...
func (c *Client) MoveAsync(fromAccount, toAccount string, amount btcutil.Amount) FutureMoveResult {
	cmd := sebtcjson.NewMoveCmd(fromAccount, toAccount, amount.ToBTC(), nil,
		nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) MoveMinConfAsync(fromAccount, toAccount string,
	...
	cmd := sebtcjson.NewMoveCmd(fromAccount, toAccount, amount.ToBTC(),
		&minConfirms, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) RenameAccountAsync(oldAccount, newAccount string) FutureRenameAccountResult {
	cmd := sebtcjson.NewRenameAccountCmd(oldAccount, newAccount)
	return c.sendCmd(cmd)
}
...
func (r FutureValidateAddressResult) Receive() (*sebtcjson.ValidateAddressWalletResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var addrResult sebtcjson.ValidateAddressWalletResult
...
func (c *Client) ValidateAddressAsync(address btcutil.Address) FutureValidateAddressResult {
	addr := address.EncodeAddress()
	cmd := sebtcjson.NewValidateAddressCmd(addr)
	return c.sendCmd(cmd)
}

// ValidateAddress returns information about the given bitcoin address.
func (c *Client) ValidateAddress(address btcutil.Address) (*sebtcjson.ValidateAddressWalletResult, error) {
...
func (c *Client) KeyPoolRefillAsync() FutureKeyPoolRefillResult {
	cmd := sebtcjson.NewKeyPoolRefillCmd(nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) KeyPoolRefillSizeAsync(newSize uint) FutureKeyPoolRefillResult {
	cmd := sebtcjson.NewKeyPoolRefillCmd(&newSize)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListAccountsAsync() FutureListAccountsResult {
	cmd := sebtcjson.NewListAccountsCmd(nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListAccountsMinConfAsync(minConfirms int) FutureListAccountsResult {
	cmd := sebtcjson.NewListAccountsCmd(&minConfirms)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetBalanceAsync(account string) FutureGetBalanceResult {
	cmd := sebtcjson.NewGetBalanceCmd(&account, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetBalanceMinConfAsync(account string, minConfirms int) FutureGetBalanceResult {
	cmd := sebtcjson.NewGetBalanceCmd(&account, &minConfirms)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetReceivedByAccountAsync(account string) FutureGetReceivedByAccountResult {
	cmd := sebtcjson.NewGetReceivedByAccountCmd(account, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetReceivedByAccountMinConfAsync(account string, minConfirms int) FutureGetReceivedByAccountResult {
	cmd := sebtcjson.NewGetReceivedByAccountCmd(account, &minConfirms)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetUnconfirmedBalanceAsync(account string) FutureGetUnconfirmedBalanceResult {
	cmd := sebtcjson.NewGetUnconfirmedBalanceCmd(&account)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetReceivedByAddressAsync(address btcutil.Address) FutureGetReceivedByAddressResult {
	addr := address.EncodeAddress()
	cmd := sebtcjson.NewGetReceivedByAddressCmd(addr, nil)
	return c.sendCmd(cmd)
...
func (c *Client) GetReceivedByAddressMinConfAsync(address btcutil.Address, minConfirms int) FutureGetReceivedByAddressResult {
	addr := address.EncodeAddress()
	cmd := sebtcjson.NewGetReceivedByAddressCmd(addr, &minConfirms)
	return c.sendCmd(cmd)
}
...
// Receive waits for the response promised by the future and returns a list of
// balances by account.
func (r FutureListReceivedByAccountResult) Receive() ([]sebtcjson.ListReceivedByAccountResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var received []sebtcjson.ListReceivedByAccountResult
...
func (c *Client) ListReceivedByAccountAsync() FutureListReceivedByAccountResult {
	cmd := sebtcjson.NewListReceivedByAccountCmd(nil, nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListReceivedByAccount() ([]sebtcjson.ListReceivedByAccountResult, error) {
...
func (c *Client) ListReceivedByAccountMinConfAsync(minConfirms int) FutureListReceivedByAccountResult {
	cmd := sebtcjson.NewListReceivedByAccountCmd(&minConfirms, nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListReceivedByAccountMinConf(minConfirms int) ([]sebtcjson.ListReceivedByAccountResult, error) {
...
func (c *Client) ListReceivedByAccountIncludeEmpty(minConfirms int, includeEmpty bool) ([]sebtcjson.ListReceivedByAccountResult, error) {
...
// Receive waits for the response promised by the future and returns a list of
// balances by address.
func (r FutureListReceivedByAddressResult) Receive() ([]sebtcjson.ListReceivedByAddressResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var received []sebtcjson.ListReceivedByAddressResult
	err = json.Unmarshal(res, &received)
	if err != nil {
		return nil, err
	}
...
func (c *Client) ListReceivedByAddressAsync() FutureListReceivedByAddressResult {
	cmd := sebtcjson.NewListReceivedByAddressCmd(nil, nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListReceivedByAddress() ([]sebtcjson.ListReceivedByAddressResult, error) {
...
func (c *Client) ListReceivedByAddressMinConfAsync(minConfirms int) FutureListReceivedByAddressResult {
	cmd := sebtcjson.NewListReceivedByAddressCmd(&minConfirms, nil, nil)
	return c.sendCmd(cmd)
}
...
// received any payments in the results.
func (c *Client) ListReceivedByAddressMinConf(minConfirms int) ([]sebtcjson.ListReceivedByAddressResult, error) {
...
func (c *Client) ListReceivedByAddressIncludeEmpty(minConfirms int, includeEmpty bool) ([]sebtcjson.ListReceivedByAddressResult, error) {
...
func (c *Client) WalletLockAsync() FutureWalletLockResult {
	cmd := sebtcjson.NewWalletLockCmd()
	return c.sendCmd(cmd)
}
...
func (c *Client) WalletPassphrase(passphrase string, timeoutSecs int64) error {
	cmd := sebtcjson.NewWalletPassphraseCmd(passphrase, timeoutSecs)
...
func (c *Client) WalletPassphraseChangeAsync(old, new string) FutureWalletPassphraseChangeResult {
	cmd := sebtcjson.NewWalletPassphraseChangeCmd(old, new)
	return c.sendCmd(cmd)
}
...
func (c *Client) SignMessageAsync(address btcutil.Address, message string) FutureSignMessageResult {
	addr := address.EncodeAddress()
	cmd := sebtcjson.NewSignMessageCmd(addr, message)
	return c.sendCmd(cmd)
}
...
func (c *Client) VerifyMessageAsync(address btcutil.Address, signature, message string) FutureVerifyMessageResult {
	addr := address.EncodeAddress()
	cmd := sebtcjson.NewVerifyMessageCmd(addr, signature, message)
	return c.sendCmd(cmd)
}
...
func (c *Client) DumpPrivKeyAsync(address btcutil.Address) FutureDumpPrivKeyResult {
	addr := address.EncodeAddress()
	cmd := sebtcjson.NewDumpPrivKeyCmd(addr)
	return c.sendCmd(cmd)
}
...
func (c *Client) ImportPrivKeyAsync(privKeyWIF *btcutil.WIF) FutureImportPrivKeyResult {
	...
	cmd := sebtcjson.NewImportPrivKeyCmd(wif, nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ImportPrivKeyLabelAsync(privKeyWIF *btcutil.WIF, label string) FutureImportPrivKeyResult {
	...
	cmd := sebtcjson.NewImportPrivKeyCmd(wif, &label, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ImportPrivKeyRescanAsync(privKeyWIF *btcutil.WIF, label string, rescan bool) FutureImportPrivKeyResult {
	...
	cmd := sebtcjson.NewImportPrivKeyCmd(wif, &label, &rescan)
	return c.sendCmd(cmd)
}
...
func (c *Client) ImportPubKeyAsync(pubKey string) FutureImportPubKeyResult {
	cmd := sebtcjson.NewImportPubKeyCmd(pubKey, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ImportPubKeyRescanAsync(pubKey string, rescan bool) FutureImportPubKeyResult {
	cmd := sebtcjson.NewImportPubKeyCmd(pubKey, &rescan)
	return c.sendCmd(cmd)
}
...
func (r FutureGetInfoResult) Receive() (*sebtcjson.InfoWalletResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var infoRes sebtcjson.InfoWalletResult
...
func (c *Client) GetInfo() (*sebtcjson.InfoWalletResult, error) {
